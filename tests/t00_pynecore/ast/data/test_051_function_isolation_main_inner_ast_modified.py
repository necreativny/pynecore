...
__series_main_t_a__ = SeriesImpl()
__series_function_vars__ = {'main.t': ['__series_main_t_a__']}
__scope_id__ = ''
...
def main():
    ...
    def t():
        a = __series_main_t_a__.add(1)
        a = __series_main_t_a__.set(a + 1)
        return __series_main_t_a__[1]
